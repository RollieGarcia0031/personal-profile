import"./header-DPd5T74P.js";import{w as m}from"./register-service-worker-BGOs9hDu.js";import{c as D}from"./createPubSub-Ze6cNm9A.js";const $=(t,e,i,r,s,a,u,C,N)=>{const R=m(C),h=m(N),q=m(`track-info/${u}/`);return`
  <div class="track-option-container">
    ...
    <div class="track-img-container">
      ...
      <img alt="${e}" src="${h}" class="backdrop"/>
      <img alt="${e}" src="${h}" class="frontdrop"/>
    </div>
    <p class="track-genre">
      ${r}
    </p>
